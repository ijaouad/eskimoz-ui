...
function Icon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="26" viewBox="0 0 25 22" fill="none">
            <path d="M12.1113 12.2877V8.13216" stroke="#CD1F1F" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M14.3653 2.30917L22.8753 17.2025C23.8642 18.9336 22.6142 21.0881 20.6208 21.0881H3.60085C1.6064 21.0881 0.356403 18.9336 1.3464 17.2025L9.8564 2.30917C10.8531 0.563611 13.3686 0.563611 14.3653 2.30917Z" stroke="#CD1F1F" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
